...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    ...
    {5, {259, "One finger up swipe", "/proc/touchpanel/up_swipe_enable"}},
    {6, {258, "One finger down swipe", "/proc/touchpanel/down_swipe_enable"}},
    {7, {257, "One finger left swipe", "/proc/touchpanel/left_swipe_enable"}},
    {8, {256, "One finger right swipe", "/proc/touchpanel/right_swipe_enable"}},
    {9, {250, "Letter O", "/proc/touchpanel/letter_o_enable"}},
    {10, {261, "Letter M", "/proc/touchpanel/letter_m_enable"}},
    {11, {260, "Letter W", "/proc/touchpanel/letter_w_enable"}},
};
